...
function excludeLink(link, instance)
{
	...
	//if (instance.options.excludeExternalLinks===true   && link.internal===false) //before
	if (instance.options.excludeExternalLinks===true   && !link.baseInternal) //after
		return "BLC_EXTERNAL";
	...
	//新增包含某些关键字筛选
	if (instance.options.includedKeywords && matchUrl(link.url.resolved, instance.options.includedKeywords) !== true) return "BLC_KEYWORD";
